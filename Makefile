...
JADEBASE_DPI_HPP = src/dynamics/jb_dpi.hpp ${JADEBASE_DYNAMIC_HPP}
...
JADEBASE_ELEMENT_HPP = src/gui/jb_element.hpp ${JADEBASE_DPI_HPP} ${JADEBASE_MUTEX_HPP} ${JADEBASE_CALLBACK_HPP} ${JADEBASE_PLATFORM_H} ${JADEBASE_WINDOWEVENT_HPP}
