...
test_group_b = jade.gui.new_group( 0, 0, 256, 256 )

test_group_b:add_element( jade.gui.new_dial( 10, 10 ) )
test_group_b:add_element( jade.gui.new_dial( 62, 10, true ) )

-- Group C

test_group_c = jade.gui.new_group( 0, 0, 256, 256 )
